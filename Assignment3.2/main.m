...
for i=1:Ns+1
    ...
    % reference models
    omega_ref = 0.03;
    %[Ad,Bd,Cd,Dd] = tf2ss([0    omega_ref.^3],[1    3*omega_ref     3*omega_ref.^2  omega_ref.^3]);
    Ad = [0 1 0;
          0 0 1;
          -omega_ref^3 -3*omega_ref^2   -3*omega_ref];
    Bd = [0 0 omega_ref^3]';
    xd_dot = Ad*xd + Bd*psi_ref(i);
    ...
    % control law
    delta_c = PID_heading(x(6),psi_d,x(3), r_d,i,h);
...
subplot(312)
plot(t,psi,t,psi_d,t,psi_ref*(180/pi),'linewidth',2);
