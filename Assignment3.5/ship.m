...
B = 21.8;               % beam (m)
T = 8.9;                % draft (m)
KT = 0.6367;            % propeller torque coefficient (-)
KQ = 0.1390;            % propeller moment coefficient
...
Q_c = rho * Dia^5 * KQ * abs(n_c) * n_c;
y = Q_c / K_m;
Q_m_dot = 1/T_m * (-Q_m + K_m *y);
n_dot = (Q_m - Q) / I_m;
